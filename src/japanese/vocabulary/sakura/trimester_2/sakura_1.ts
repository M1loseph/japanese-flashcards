...
export const sakura_2_1: JapaneseWord[] = [
    {
        type: 'phrase',
        en: 'Happy New Year!',
    ...
    },
    {
        ...
        jp: 'きんようびにびじゅつかんにいきます。',
        jp_description: 'The particle "に" is used after "きんようび" (Friday), just like with other days of the week.',
    },
    {
        type: 'phrase',
        en: 'On Friday evening I watch TV.',
        pl: 'W piątkowy wieczór oglądam telewizję.',
        jp: 'きんようびのゆうがたテレビをみます。',
        jp_description:
