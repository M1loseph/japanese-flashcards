    ...
    return (
        ...
        `}
            >
                ...
                <span className={`text-lg font-medium ${selectedLanguage === TranslationLanguages.POLISH ? 'text-primary' : 'text-slate-600'}`}>
                    Polish
                </span>
                {selectedLanguage === TranslationLanguages.POLISH && (
        ...
        `}
            >
                <span className="text-4xl group-hover:scale-110 transition-transform duration-200">🇬🇧</span>
                <span className={`text-lg font-medium ${selectedLanguage === TranslationLanguages.ENGLISH ? 'text-primary' : 'text-slate-600'}`}>
                    English
                </span>
                {selectedLanguage === TranslationLanguages.ENGLISH && (
                    <div className="absolute top-3 right-3 w-3 h-3 bg-primary rounded-full" />
